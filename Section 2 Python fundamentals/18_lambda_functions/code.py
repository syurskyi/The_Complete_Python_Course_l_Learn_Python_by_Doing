...
# For example, the `print()` function is a function that performs an action. As such,
# it would not be suitable for lambda function.
...
# This spacing is common. After each comma in the parameters, after the colon but not before,
...
# The main reason to use lambda function is because they are short, so if we use them in conjunction with
# other functions that can help make our programs a bit more flexible.
