...
# they can be passed as arguments to functions or assigned to variables. Here's a simple
# (yet not terribly useful) example to illustrate it:
...
# `before_and_after` is a higher-order function. That just means it's a function which has another function
# as a parameter.
